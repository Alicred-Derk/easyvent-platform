      ...
      <div className="w-full flex items-center justify-center py-[2rem]">
        <Card className="overflow-hidden w-[60%] rounded-md shadow-xs">
          <CardContent className="px-[3rem] py-[0.5rem]">
            <div className="font-title mb-[0.5rem] font-bold text-[1.5rem]">Profile</div>
            <p className="mb-[3rem] text-gray-500">Finish setting up your profile name, contacts and other details to continue.</p>
